            ...
            <div class="modal-body">
                <form class="form-horizontal" id="editForm" role="form" method="post">
                    <div class="form-group" style="display: none">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control"  id="equipIdEdit" name="equipId"
                                    >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="equipNameEdit" name="equipName"  >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="equipTotalEdit">器材总数</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control"  id="equipTotalEdit" name="equipTotal"
                                   placeholder="请输入器材总数">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="equipRestEdit" name="equipRest"
                                   placeholder="请输入器材余数">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="equipConstEdit">每件租金(元)</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="equipConstEdit" name="equipConst"
...
<script>
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                for(var index=0; index<data.length;index++){
                    ...
                    cell1.innerHTML  = '<input type="checkbox" class="checkItem"  /> '
                    var equipId = data[index].equipId;
                    console.log(equipId)
                    $('.checkItem')[index].setAttribute("id",equipId)
                    // $('.checkItem').attr('value', equipId);
                    cell2.innerText =data[index].equipName;
                    cell3.innerText =data[index].equipTotal;
                    cell4.innerText =data[index].equipRest;
                    cell5.innerText =data[index].equipConst;
                    cell6.innerHTML  = '<input class="btn btn-default editEquip" type="button" value="编辑" data-toggle="modal" >'
                    cell6.setAttribute("id",equipId);
                    cell6.onclick = function() { equipMsg($(this).attr('id'))};
                }
            },
            error : function() {
    ...
    // 根据器材 ID，获取器材数据用于修改器材
    function equipMsg(id) {
        // var name = index.getElementsByTagName('td')[0];
        console.log('id',id);
        $.ajax({
            type: "post",
            ...
            success : function(data) {
                ...
                if (data.result ="success"){
                    $('#equipIdEdit').attr('value',data.equipId);
                    $('#equipNameEdit').attr('value',data.equipName);
                    console.log(data.equipName)
                    $('#equipTotalEdit').attr('value',data.equipTotal);
                    $('#equipRestEdit').attr('value',data.equipRest);
                    $('#equipConstEdit').attr('value',data.equipConst);
