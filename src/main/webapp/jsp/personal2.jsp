...
<div class="top">
    <div class="logo" align="left">
        <img src="logo1.jpg" width="100" height="100"  style="border-radius:50% ;margin-top: 30px;margin-left: 35px">
    </div>
    <div class="title">
...
<div class="main">
    ...
    <button class="loader" type=" " ><a href="personal2_1.html" >修改资料</a></button>
</div>
<!-- 底部-->
