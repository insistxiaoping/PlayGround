...
<div class="top">
    ...
    <div class="sub_notice">
        <ul>
            ...
            <li style="float:left ;list-style: none;"><a href="${pageContext.request.contextPath}/links/NotSportActivity"style="background-color: #E6E6FA;">非体育类活动</a></li>
            <li style="float:left ;list-style: none;"><a href="${pageContext.request.contextPath}/links/LostAndFound" >失物招领</a></li>
        </ul>
    </div>
</div>
<!--这是左边导航-->
